...
import { MatTableExporterModule } from 'mat-table-exporter';
 ...
 import { DynamicDirective } from 'projects/test-app/src/app/dynamic.directive';
  import { MarkAsteriskDirective } from '../directive/mark-asterisk.directive';
import { CustomDateAdapter } from '../custom.date.adapter';
@NgModule({
  declarations: [TimeFormat, InjectorComponent, DynamicDirective,
  ...
  providers:[{ provide: MAT_DATE_LOCALE, useValue: 'en-GB' }, { provide: DateAdapter, useClass: CustomDateAdapter }]
})
