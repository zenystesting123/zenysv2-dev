...
import { DocSettingsBottomSheetComponent } from 'src/app/doc-management/doc-settings-bottom-sheet/doc-settings-bottom-sheet.component';
...
export class DocumentFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.commonService.userDatas
      ...
      .subscribe((datas) => {
        this.isMobilesize = datas.isMobileSize; // check screen size
        if (datas.authDetails) {
          this.userId = datas.authDetails.uid;
          this.email = datas.authDetails.email;
          this.userName = datas.authDetails.displayName;
          let details = datas.userDetails;
          if (!details) {
  ...
  clearDeliveryAddress(){
    this.customerData.deliveryPinCode = null;
    this.customerData.deliveryDistrict= null;
    this.customerData.deliveryState= null;
    this.customerData.deliveryCountry= null;
    this.customerData.deliveryContactName= null;
    this.customerData.deliveryAddressline1= null;
    this.customerData.deliveryAddressline2= null;
  }
  copyDeliveryAddress(){
    this.customerData.deliveryPinCode =   this.customerData.pinCode;
    this.customerData.deliveryDistrict= this.customerData.district;
    this.customerData.deliveryState= this.customerData.state;
    this.customerData.deliveryCountry= this.customerData.country;
    this.customerData.deliveryContactName= this.customerData.fname1;
    this.customerData.deliveryAddressline1= this.customerData.addressline1;
    this.customerData.deliveryAddressline2= this.customerData.addressline2;
  }
}
