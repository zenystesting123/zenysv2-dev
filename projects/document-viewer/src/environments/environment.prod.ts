export const environment = {
  ...
  clientId:
    '461454236300-oq7a7ui7vnqavdns0d2gfr231uujjnor.apps.googleusercontent.com', //for GAPI
  ZenysMainAccount: 'WlWjGoPwE5enWHWGDZMK6EVk5CA2',
  ZenysAssignedToName: 'Mohana Krishnan',
  docViewerDomain: 'zenysdocviewerprod.web.app',
  currentUrl: 'https://crm.zenys.org/',
  firebase: {
  ...
  cloudFunctions: {
    createOrder:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createOrder',
    capturePayment:
      'https://europe-west3-zenysproduction.cloudfunctions.net/capturePayments',
    subscription:
      'https://europe-west3-zenysproduction.cloudfunctions.net/subscriptions',
    getpayment:
      'https://europe-west3-zenysproduction.cloudfunctions.net/getpayment',
    subplans:
      'https://europe-west3-zenysproduction.cloudfunctions.net/getplansubs',
    invoices:
      'https://europe-west3-zenysproduction.cloudfunctions.net/getallinvoice',
    makepaylink:
      'https://europe-west3-zenysproduction.cloudfunctions.net/axiostest',
    collectionOperation:
      'https://europe-west3-zenysproduction.cloudfunctions.net/collectionOperation',
    mailer: 'https://europe-west3-zenysproduction.cloudfunctions.net/mailer',
    mailparser:
      'https://europe-west3-zenysproduction.cloudfunctions.net/mailparseincoming',
    nodemailer:
      'https://europe-west3-zenysproduction.cloudfunctions.net/nodemailer',
    cancelsubscription:
      'https://europe-west3-zenysproduction.cloudfunctions.net/cancelsubscriptions',
    getsubscriptioninvoices:
      'https://europe-west3-zenysproduction.cloudfunctions.net/getsubscriptioninv',
    getsubscription:
      'https://europe-west3-zenysproduction.cloudfunctions.net/getsubscription',
    InquiryNotification:
      'https://europe-west3-zenysproduction.cloudfunctions.net/InquiryNotification',
    ChatNotification:
      'https://europe-west3-zenysproduction.cloudfunctions.net/ChatNotification',
    sendnotification:
      'https://europe-west3-zenysproduction.cloudfunctions.net/sendnotification',
    contactAutomation:
      'https://europe-west3-zenysproduction.cloudfunctions.net/contactautomationTest',
    updateSubscription:
      'https://europe-west3-zenysproduction.cloudfunctions.net/subscriptionsUpdate',
    createSubMerchant:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createSubMerchant',
    createSubMerchantPayLink:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createSubMerchantPayLink',
    createStripe:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createStripeAccount',
    retriveStripe:
      'https://europe-west3-zenysproduction.cloudfunctions.net/retrieveStripeAccount',
    scheduledFunction:
      'https://europe-west3-zenysproduction.cloudfunctions.net/scheduledFunction',
    checkoutSession:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createStripeCheckoutSession',
    retrieveSession:
      'https://europe-west3-zenysproduction.cloudfunctions.net/retireveStripeCheckoutSession',
    createAccountLink:
      'https://europe-west3-zenysproduction.cloudfunctions.net/createAccountLink',
    updatePaymentAmountOnEdit:
      'https://europe-west3-zenysproduction.cloudfunctions.net/PaymentReceiptAmountUpdateOnEdit',
      ivrAutoCall:
      'https://europe-west3-zenysproduction.cloudfunctions.net/autoCall',
      leadCaptureForm:
      'https://europe-west3-zenysproduction.cloudfunctions.net/leadCaptureForm'
  },
  ...
  leadCaptureDomain: 'http://zenysleadcapture.web.app',
