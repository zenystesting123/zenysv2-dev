...
import { FollowupDirection, FollowupOutcome, FollowupStatus } from 'src/app/data-models';
...
export class DocumentFormService {
  ...
  createSale(saleDetail: SalesDetails, superUserId) {
    saleDetail.stageHistory = saleDetail.stageHistory.map((obj) => {
      return Object.assign({}, obj);
    });
    return this.db
      .collection('users/' + superUserId + '/sales')
      .add(Object.assign({}, saleDetail));
  }
