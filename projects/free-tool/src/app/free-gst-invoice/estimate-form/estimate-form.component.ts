import { DocType } from './../data.model';
import { ChangeDetectorRef, Component, Directive, Input, NgModule, OnChanges,DoCheck, OnInit, SimpleChanges, ViewChild } from '@angular/core';
...
export class EstimateFormComponent implements OnInit ,OnChanges {
  ...
  isChecked:boolean;
    ...
    lineItem: LineItemData = { slno: 0, amount: null, unit: null, amountInclTax: null, item: null, qty: null, rate: null,discountedAmount:null, discountRate:0,discountAmount:null, cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0,vatRate:0,vatAmount:null, cgstAmount: null, igstAmount: null, sgstAmount: null, cessAmount: null, description: null ,hsnCode :null};//initializing the LineItemData interface
    itemList = [this.lineItem];
    submitted: boolean = false; // for Checking if the required fields are filled before submitting
    isCollapsed = false;
    includetax: boolean = true; //for checking if the tax is selected
  ...
  hubSpotChat:any;
     constructor(
      ...
      private meta:Meta
        ...
        this.titleService.setTitle("Free Estimate Maker | Free Online Estimate Template | Zenys");
                  // update meta tags
          this.meta.updateTag({ name: 'description', content: "Zenys Free Estimate Generator lets you create estimates with your business logo. Fill in the fields and download the PDF Estimates with our Free Estimate Maker." })
          this.meta.updateTag({ name: 'og:title', content: "Estimate Maker, Estimate Generator,Estimate Template" })
          this.meta.updateTag({ name: 'og:description', content: "Zenys Free Estimate Generator lets you create estimates with your business logo. Fill in the fields and download the PDF Estimates with our Free Estimate Maker." })
          this.meta.updateTag({ name: 'og:url', content:"https://crm.zenys.org/free-tool/create/Estimate"}) 
   ...
   createForm():void{
    ...
    addFieldValue() {
      ...
      var emptyPayOff = { slno: this.noItem, unit: null, amountInclTax: null, amount: null, item: null, qty: null, rate: null, 
        discountRate:0,discountAmount:null, 
        cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0,vatRate:0,vatAmount:null, cgstAmount: null,discountedAmount:null, igstAmount: null, sgstAmount: null, cessAmount: null, description: null ,hsnCode :null};
