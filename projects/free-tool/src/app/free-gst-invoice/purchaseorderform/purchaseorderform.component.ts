import { DocType, ShippingData } from './../data.model';
...
@Component({
  selector: 'app-purchaseorderforms',
...
export class PurchaseorderformComponent implements OnInit {
  ...
  lineItem: LineItemData = { slno: 0, amount: null, unit: null, amountInclTax: null, item: null, qty: null, rate: null, cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0, vatRate: 0, vatAmount: null,
    discountRate:0,discountAmount:null,discountedAmount:null,
    cgstAmount: null, igstAmount: null, sgstAmount: null, cessAmount: null, description: null ,hsnCode:null};//initializing the LineItemData interface
  ...
  constructor(private ref: ChangeDetectorRef, private meta:Meta, public toastr: ToastrService, private titleService: Title,
    ...
    // update meta tags
this.meta.updateTag({ name: 'description', content: "Zenys Purchase Order Generator lets you create PO with your business logo. Fill in the fields and download in PDF format with our Free Purchase Order Maker." })
this.meta.updateTag({ name: 'og:title', content: "Purchase Order Maker, PO  Generator,P O Template" })
this.meta.updateTag({ name: 'og:description', content: "Zenys Purchase Order Generator lets you create PO with your business logo. Fill in the fields and download in PDF format with our Free Purchase Order Maker.." })
this.meta.updateTag({ name: 'og:url', content:"https://crm.zenys.org/free-tool/create/Purchase%20order"}) 
this.meta.updateTag({ name: "og:type", content:"website"})
  ...
  addFieldValue() {
    this.noItem += 1;
    var emptyPayOff = { slno: this.noItem, unit: null, amountInclTax: null, amount: null, item: null, qty: null, rate: null, cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0,
      discountRate:0,discountAmount:null,discountedAmount:null,
      vatRate: 0, vatAmount: null,  cgstAmount: null, igstAmount: null, sgstAmount: null, cessAmount: null, description: null,hsnCode:null };
