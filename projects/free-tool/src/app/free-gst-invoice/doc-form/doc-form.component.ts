...
@Component({
  selector: 'app-doc-forms',
  templateUrl: './doc-form.component.html',
  styleUrls: ['./doc-form.component.scss']
})
export class DocFormsComponent implements OnInit, OnChanges {
  ...
  lineItem: LineItemData = { slno: 0, amount: null, unit: null, amountInclTax: null, item: null, qty: null, rate: null,discountedAmount:null,
    discountRate:0,discountAmount:null,  cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0,vatRate:0, cgstAmount: null, igstAmount: null, sgstAmount: null, cessAmount: null,vatAmount:null, description: null ,hsnCode:null};//initializing the LineItemData interface
  ...
  constructor(
    ...
    this.titleService.setTitle("Free GST Invoice Generator - Zenys");
                      // meta tag updation
    this.meta.updateTag({ name: 'description', content: "Zenys Free Invoice Generator lets you create invoices with your business logo. Fill in the fields and download the PDF Invoices with our Free Invoice Maker." })
    this.meta.updateTag({ name: 'og:title', content: "Free Invoice Generator, Free Online Invoice Maker, Zenys Invoice Creator" })
    this.meta.updateTag({ name: 'og:description', content: "Zenys Free Invoice Generator lets you create invoices with your business logo. Fill in the fields and download the PDF Invoices with our Free Invoice Maker." })
    this.meta.updateTag({ name: 'og:url', content:"https://crm.zenys.org/free-tool/create/Invoice"}) 
  ...
  addFieldValue() {
    ...
    var emptyPayOff = { slno: this.noItem, unit: null, amountInclTax: null, amount: null, item: null, qty: null, rate: null,
      ...
      cgstRate: 0, igstRate: 0, sgstRate: 0, cessRate: 0,vatRate:0, cgstAmount: null, igstAmount: null, sgstAmount: null, cessAmount: null,vatAmount:null, description: null, hsnCode  :null};
    this.emptyItemObject=emptyPayOff;
