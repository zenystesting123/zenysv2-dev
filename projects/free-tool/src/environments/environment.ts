...
export const environment = {
  production: false,
  clientId: '1059747170002-24tpagkhb5e3iqurb3r4uagcdtd4nb71.apps.googleusercontent.com', //for GAPI
  firebaseConfig : {
...
// development
  ...
  mailparser: "https://asia-east2-zenysdevelopment.cloudfunctions.net/mailparseincoming",
  nodemailer:"https://asia-east2-zenysdevelopment.cloudfunctions.net/nodemailer",
  cancelsubscription:"https://asia-east2-zenysdevelopment.cloudfunctions.net/cancelsubscriptions",
  getsubscriptioninvoices:"https://asia-east2-zenysdevelopment.cloudfunctions.net/getsubscriptioninv",
  getsubscription:"https://asia-east2-zenysdevelopment.cloudfunctions.net/getsubscription",
  InquiryNotification : "https://asia-east2-zenysdevelopment.cloudfunctions.net/InquiryNotification",
  ChatNotification : "https://asia-east2-zenysdevelopment.cloudfunctions.net/ChatNotification",
  sendnotification: "https://asia-east2-zenysdevelopment.cloudfunctions.net/sendnotification",
  contactAutomation:"https://asia-east2-zenysdevelopment.cloudfunctions.net/contactautomationTest",
  updateSubscription:"https://asia-east2-zenysdevelopment.cloudfunctions.net/subscriptionsUpdate",
  createSubMerchant:"http://localhost:5000/zenysdevelopment/asia-east2/createSubMerchant",
  scheduledFunction:"http://localhost:5001/zenysdevelopment/asia-east2/scheduledFunction"
...
// contactAutomation:"https://europe-west3-zenysproduction.cloudfunctions.net/contactautomationTest"
  ...
  RZP_YEARY_PLAN_ID :{ India :'plan_HUM0WNozVCbSHX',
  Europe:"plan_yearly_gold_europe",
  US:"plan_yearly_gold_Us"
},
  RZP_MONTHLY_PLAN_ID_DMD : {India:'plan_HzzTGb8mkk5PXs',
  Europe:"plan_monthly_diamond_europe",
  US:"plan_monthly_diamond_Us"
},
  RZP_YEARY_PLAN_ID_DMD : {India:'plan_HzzTs3K4RsVF9s',
